...
import { getQuizqs, postQuizReport } from '../../actions/quizqs'
import { MARK_DONE, SET_ALERT, UPDATE_ATTEMPT, UPDATE_SCORE, UPDATE_SELECTED, UPDATE_TIME } from '../../constants/actions'
...
const QuizQuestions = ({ match }) => {
    ...
    useEffect(() => {
        dispatch(getQuizqs(Number(noOfqs)))
    ...
    // useEffect(()=>{
    //     const score=quizqs.score
    //     dispatch({type:UPDATE_SCORE,payload:{id:page-1,}})
    // },[solved])
                                    ...
                                    <Paper className={classes.quizCont}>
                                        <Grid className={classes.qInnerContainer} container spacing={2}>
                                            ...
                                            <Grid item xs={12} className={classes.btnContainer}>
                                                <Button onClick={() => setPage(prev => prev === 1 ? 1 : prev - 1)} color="primary" variant="contained" className={classes.btn}>
                                                    Prev
                                                </Button>
                                                {
                                                ...
                                                <Button onClick={() => setPage(prev => prev === Number(noOfqs) ? Number(noOfqs) : prev + 1)} color="primary" variant="contained" className={classes.btn}>
                                                    Next
                                                </Button>
                                            </Grid>
